...
def parse_args():
    parser = argparse.ArgumentParser(description="Run MsRec.")
    ...
    parser.add_argument('--dataset', nargs='?', default='qiaoji_5_6.1',
    ...
    parser.add_argument('--lr', type=float, default=0.002,
                        help='Learning rate.')
    parser.add_argument('--model_type', nargs='?', default='MsRec',
                        help='Specify the name of model (MsRec).')
    parser.add_argument('--adj_type', nargs='?', default='norm_adj',
                        help='Specify the type of the adjacency (laplacian) matrix from {plain, norm, mean}.')
    parser.add_argument('--alg_type', nargs='?', default='MsRec')
